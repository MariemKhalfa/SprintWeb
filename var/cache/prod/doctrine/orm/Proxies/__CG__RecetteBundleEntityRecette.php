...
namespace Proxies\__CG__\RecetteBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Recette extends \RecetteBundle\Entity\Recette implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'RecetteBundle\\Entity\\Recette' . "\0" . 'id', '' . "\0" . 'RecetteBundle\\Entity\\Recette' . "\0" . 'video', '' . "\0" . 'RecetteBundle\\Entity\\Recette' . "\0" . 'description', '' . "\0" . 'RecetteBundle\\Entity\\Recette' . "\0" . 'titre'];
        }
