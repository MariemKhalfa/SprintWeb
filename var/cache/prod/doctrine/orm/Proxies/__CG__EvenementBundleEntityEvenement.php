...
class Evenement extends \EvenementBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'id', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'intitule', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'nbParticipants', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'budget', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'adresse', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'date', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'image', '' . "\0" . 'EvenementBundle\\Entity\\Evenement' . "\0" . 'categorie'];
        }
