...
namespace Proxies\__CG__\MedecinBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Medecins extends \MedecinBundle\Entity\Medecins implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'id', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'nom', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'prenom', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'specialite', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'telephone', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'adresse', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'email', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'image', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'longitude', '' . "\0" . 'MedecinBundle\\Entity\\Medecins' . "\0" . 'latitude'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Medecins $proxy) {
