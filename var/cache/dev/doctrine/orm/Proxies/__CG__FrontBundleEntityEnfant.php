 ...
 */
class Enfant extends \FrontBundle\Entity\Enfant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'FrontBundle\\Entity\\Enfant' . "\0" . 'pseudonyme', '' . "\0" . 'FrontBundle\\Entity\\Enfant' . "\0" . 'age', '' . "\0" . 'FrontBundle\\Entity\\Enfant' . "\0" . 'sexe', '' . "\0" . 'FrontBundle\\Entity\\Enfant' . "\0" . 'cin'];
        }
    ...
    public function getPseudonyme()
    {
        if ($this->__isInitialized__ === false) {
            return  parent::getPseudonyme();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPseudonyme', []);
