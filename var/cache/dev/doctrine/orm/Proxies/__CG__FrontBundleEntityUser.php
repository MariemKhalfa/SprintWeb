...
namespace Proxies\__CG__\FrontBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \FrontBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'CIN', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'prenom', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'sexe', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'dateNaissance', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'rue', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'ville', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'codePostal', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'telephone', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'nbreEnfants', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'babysitter', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'covoiturage', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'photo', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'specialite', '' . "\0" . 'FrontBundle\\Entity\\User' . "\0" . 'description', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function getBabysitter()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getBabysitter', []);

        return parent::getBabysitter();
    }
    ...
    public function setBabysitter($babysitter)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBabysitter', [$babysitter]);

        return parent::setBabysitter($babysitter);
    }
    ...
    public function getCovoiturage()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCovoiturage', []);

        return parent::getCovoiturage();
    }
    ...
    public function setCovoiturage($covoiturage)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCovoiturage', [$covoiturage]);

        return parent::setCovoiturage($covoiturage);
    }
