    ...
    public function match($rawPathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/medecin')) {
            ...
            elseif (0 === strpos($pathinfo, '/medecin/garderie')) {
                ...
                if (0 === strpos($pathinfo, '/medecin/garderies')) {
                    // garderie_afficher6
                    if ('/medecin/garderiesAll' === $pathinfo) {
                        return array (  '_controller' => 'MedecinBundle\\Controller\\MedecinController::allallAction',  '_route' => 'garderie_afficher6',);
                    }

                    // garderie_rate
                    if ('/medecin/garderiesRating' === $pathinfo) {
                        return array (  '_controller' => 'MedecinBundle\\Controller\\MedecinController::newAction',  '_route' => 'garderie_rate',);
                    }

                    // garderie_inscription5
                    if ('/medecin/garderiesInscription5' === $pathinfo) {
                        return array (  '_controller' => 'MedecinBundle\\Controller\\MedecinController::new1Action',  '_route' => 'garderie_inscription5',);
                    }
            ...
            elseif (0 === strpos($pathinfo, '/medecin/a')) {
                ...
                // ajouter_publication
                if ('/medecin/addPublication' === $pathinfo) {
                    return array (  '_controller' => 'MedecinBundle\\Controller\\PublicationController::ajoutPublicationAction',  '_route' => 'ajouter_publication',);
                }

                // ajouter_commentaire
                if ('/medecin/addCommentaire' === $pathinfo) {
                    return array (  '_controller' => 'MedecinBundle\\Controller\\PublicationController::ajoutCommentaireAction',  '_route' => 'ajouter_commentaire',);
                }

            }

            elseif (0 === strpos($pathinfo, '/medecin/detailsmedecin')) {
                // medecin_details
                ...
                // medecin2_details
                if ('/medecin/detailsmedecin5' === $pathinfo) {
                    return array (  '_controller' => 'MedecinBundle\\Controller\\MedecinController::DetailsMedecins5Action',  '_route' => 'medecin2_details',);
                }
            ...
            if (0 === strpos($pathinfo, '/medecin/rechercherMedecin')) {
                // medecin_rechercher
                ...
                // rechercher_Medecin
                if ('/medecin/rechercherMedecin22' === $pathinfo) {
                    return array (  '_controller' => 'MedecinBundle\\Controller\\MedecinController::allallMedecinsAction',  '_route' => 'rechercher_Medecin',);
                }
        ...
        if (0 === strpos($pathinfo, '/register')) {
            ...
            if ('/register' === $pathinfo) {
                return array (  '_controller' => 'FrontBundle\\Controller\\DefaultController::registerAction',  '_route' => 'user_register',);
            }
